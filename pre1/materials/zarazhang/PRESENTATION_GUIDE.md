# HTML Presentation Creation Guide

This guide helps you create stunning, animation-rich HTML presentations from scratch or by converting PowerPoint files. Follow this guide when creating presentations for talks, pitches, tutorials, or any other purpose.
...
3. **Distinctive Design** — Avoid generic aesthetics. Every presentation should feel custom-crafted.
...
Before creating a presentation, gather information about:
...
Users can choose a style in three ways:

### Option A: Browse Available Presets
...
See `STYLE_PRESETS.md` for detailed specifications of each style.

### Option B: Generate Style Previews Based on Mood

Ask the user about the desired feeling:

**Feeling** — What feeling should the audience have?
...
Based on the mood, generate 3 distinct style previews as mini HTML files showing:
...
### Option C: Custom Style

Create a custom style based on specific requirements (colors, fonts, mood).
...
<head>
    ...
    <style>
        ...
        /* Include the mandatory viewport fitting CSS from above */
        
        /* ... Additional style-specific CSS ... */
    </style>
</head>
<body>
        ...
        class SlidePresentation {
            ...
            setupNavigation() {
                ...
                document.addEventListener('touchend', (e) => {
                    ...
                    else if (touchEnd - touchStart > 50) this.prev();
                });
            }
...
## Step 4: PowerPoint Conversion (Optional)
...
### 4.2: Generate HTML from Extracted Content
...
2. **Use visual hierarchy** — Make important content stand out
3. **Limit text** — Presentations are visual, not documents
4. **Test responsiveness** — Check on multiple device sizes
5. **Optimize images** — Compress before including
6. **Comment your code** — Future you will thank you
7. **Follow accessibility guidelines** — Everyone should be able to view your content

---

## Resources

- See `STYLE_PRESETS.md` for detailed style specifications
- Font sources: [Fontshare](https://www.fontshare.com/), [Google Fonts](https://fonts.google.com/)
- Color palette tools: [Coolors](https://coolors.co/), [Adobe Color](https://color.adobe.com/)
- Animation inspiration: [Awwwards](https://www.awwwards.com/), [Dribbble](https://dribbble.com/)
