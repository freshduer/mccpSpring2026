...
Maintaining model freshness is crucial, as model accuracy decays rapidly without updates. Even a 0.1% accuracy drop can translate to millions in lost revenue (Shan et al., n.d.; Lin et al., 2024), while update delays exceeding 5 minutes measurably reduce user engagement. Production systems require near-real-time parameter updates, but synchronizing multi-terabyte EMTs incurs significant latencies, highlighting the fundamental tension between freshness, accuracy, and overhead.
...
Shan, J., Huang, X., Guo, Y., Mao, H., Hsu, H.-P., Cheng, H., Wang, C., Song, J., Shi, R., Gao, X., et al. (n.d.). Primus: Unified training system for large-scale deep learning recommendation models.

Lin, Z., Pan, J., Zhang, S., Wang, X., Xiao, X., Huang, S., Xiao, L., & Jiang, J. (2024). Understanding the ranking loss for recommendation with sparse user feedback. In *Proceedings of the 30th ACM SIGKDD Conference on Knowledge Discovery and Data Mining* (pp. 5409–5418). ACM.
...
@article{shanprimus,
  ...
  author={Shan, Jixi and Huang, Xiuqi and Guo, Yang and Mao, Hongyue and Hsu, Ho-Pang and Cheng, Hang and Wang, Can and Song, Jun and Shi, Rui and Gao, Xiaofeng and others}
}
