...
<head>
  ...
  <style>
    body {{ font-family: "Times New Roman", "SimSun", serif; max-width: 720px; margin: 2em auto; padding: 0 1.5em; line-height: 1.6; color: #222; }}
    h1 {{ font-size: 1.8em; border-bottom: 1px solid #ccc; padding-bottom: 0.3em; margin-top: 1.2em; }}
    ...
    pre, code {{ font-family: "Consolas", "Monaco", monospace; font-size: 0.9em; background: #f5f5f5; padding: 0.2em 0.4em; border-radius: 3px; }}
    pre {{ padding: 0.8em; overflow-x: auto; }}
    .comment {{ display: none; }}
    @media print {{ body {{ max-width: none; }} a {{ color: #000; }} }}
  </style>
</head>
<body>
{body}
